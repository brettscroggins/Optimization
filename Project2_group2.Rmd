---
title: "Project 2"
author: "Group 2 - Jessica Chung, Ishita Ishita, Chloe Kwon, Brett Scroggins"
date: "Due 2/28/17"
output: pdf_document
---
...
## Comparing Models
We decided to use a rolling 20 day average stock price to calculate a new correlation matrix. This metric was selected as it smooths volitility to give a clearer picture when determining a more optimal allocation of stocks to purchase based on their potential similarity. What can be seen by the output is that this returned the highest amount of profit of any of the three choices because the new similarity matrix took into account the stocks' relevant histories.
